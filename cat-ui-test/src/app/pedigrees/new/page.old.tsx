...
export default function NewPedigreePage() {
  ...
  const fetchPedigreeOptions = async () => {
    try {
      const response = await fetch(
        'http://localhost:3004/api/v1/pedigrees?limit=1000',
      );
      if (response.ok) {
        const result = await response.json();
        const options = (result.data || []).map(
          (p: { id: string; pedigreeId: string; catName?: string }) => ({
            value: p.id,
  ...
  const fetchPedigreeById = async (pedigreeId: string) => {
    try {
      const response = await fetch(
        `http://localhost:3004/api/v1/pedigrees/pedigree-id/${pedigreeId}`,
      );
      if (response.ok) {
        const result = await response.json();
        return result;
    ...
    if (bothParentsId) {
      ...
      if (bothParentsData) {
        ...
        updateFormData(
          ...
          bothParentsData.paternalGrandfatherId,
        );
        updateFormData(
          'paternalGrandmotherId',
          bothParentsData.paternalGrandmotherId,
        );
        updateFormData(
          'maternalGrandfatherId',
          bothParentsData.maternalGrandfatherId,
        );
        updateFormData(
          'maternalGrandmotherId',
          bothParentsData.maternalGrandmotherId,
        );
        ...
        <Stack gap='lg'>
            ...
            <Grid>
              ...
              <Grid.Col span={4}>
                <NumberInput
                  ...
                  onChange={value =>
                    updateFormData('brotherCount', value || undefined)
                  }
                />
              </Grid.Col>
              <Grid.Col span={4}>
                <NumberInput
                  ...
                  onChange={value =>
                    updateFormData('sisterCount', value || undefined)
                  }
                />
              </Grid.Col>
              <Grid.Col span={4}>
                    ...
                    <Grid.Col span={6}>
                      ...
                      >
                        ...
                        <Select
                          ...
                          onChange={value =>
                            updateFormData('fatherPedigreeId', value)
                          }
                          searchable
                          clearable
                        />
                    ...
                    <Grid.Col span={6}>
                      ...
                      >
                        ...
                        <Select
                          ...
                          onChange={value =>
                            updateFormData('motherPedigreeId', value)
                          }
                          searchable
                          clearable
                        />
                      ...
                      <Stack gap='sm'>
                        <Card p='sm' withBorder>
                          ...
                          <Select
                            ...
                            onChange={value =>
                              updateFormData('paternalGrandfatherId', value)
                            }
                            searchable
                            clearable
                          />
                        ...
                        <Card p='sm' withBorder>
                          ...
                          <Select
                            ...
                            onChange={value =>
                              updateFormData('paternalGrandmotherId', value)
                            }
                            searchable
                            clearable
                          />
                      ...
                      <Stack gap='sm'>
                        <Card p='sm' withBorder>
                          ...
                          <Select
                            ...
                            onChange={value =>
                              updateFormData('maternalGrandfatherId', value)
                            }
                            searchable
                            clearable
                          />
                        ...
                        <Card p='sm' withBorder>
                          ...
                          <Select
                            ...
                            onChange={value =>
                              updateFormData('maternalGrandmotherId', value)
                            }
                            searchable
                            clearable
                          />
          ...
          >
            <Text size='sm'>
              ...
              <br />•
              血統関係は任意ですが、正確な家系図表示のために入力を推奨します
              <br />• 未入力の項目は後から編集可能です
            </Text>
          </Alert>
        </Stack>
