  ...
  if (error || !familyTree) {
    return (
      <Container component='div' size='xl' py='md'>
        ...
        <Button component='button' mt='md' onClick={() => router.back()}>
          戻る
        </Button>
      </Container>
    );
  ...
  return (
    <Container component='div' size='xl' py='md'>
      <Stack gap='md'>
        ...
        <div>
          <Title component='h1' order={1} mb='xs'>
        ...
        {/* 家系図表示 */}
        <Paper component='div' p='md' shadow='sm' style={{ overflow: 'auto' }}>
