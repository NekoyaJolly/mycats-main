...
export class CatsController {
  ...
  @ApiResponse({ status: HttpStatus.CREATED, description: '猫データが正常に作成されました' })
  ...
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: '猫データが見つかりません' })
  ...
  @ApiResponse({ status: HttpStatus.OK, description: '猫データが正常に更新されました' })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: '猫データが見つかりません' })
  @ApiResponse({ status: HttpStatus.BAD_REQUEST, description: '無効なデータです' })
  @ApiParam({ name: 'id', description: '猫データのID' })
  ...
  @ApiResponse({ status: HttpStatus.OK, description: '猫データが正常に削除されました' })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: '猫データが見つかりません' })
  @ApiParam({ name: 'id', description: '猫データのID' })
